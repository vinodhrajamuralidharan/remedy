		...
		<article class="container" id="top">
			<div class="row">
				...
				<div class="8u 12u(mobile)">
					...
					<p>
						And this is <strong>Miniport</strong>, a free, fully responsive
						HTML5 site template designed by <a href="http://twitter.com/ajlkn">AJ</a>
						for <a href="http://html5up.net">HTML5 UP</a> &amp; released under
	...
	<div class="wrapper style2">
		<article id="work">
			...
			<footer>
				...
				<a href="#portfolio" class="button big scrolly">See some of my
					recent work</a>
			</footer>
		</article>
	</div>
	...
	<div class="wrapper style3">
		<article id="portfolio">
			<header>
				...
				<p>Proin odio consequat sapien vestibulum consequat lorem dolore
					feugiat lorem ipsum dolore.</p>
			</header>
			<div class="container">
				<div class="row">
					<div class="4u 12u(mobile)">
			...
			<footer>
				<p>Lorem ipsum dolor sit sapien vestibulum ipsum primis?</p>
				<a href="#contact" class="button big scrolly">Get in touch with
					me</a>
			</footer>
		</article>
	</div>
	...
	<div class="wrapper style4">
		<article id="contact" class="container 75%">
			<header>
				...
				<p>Ornare nulla proin odio consequat sapien vestibulum ipsum sed
					lorem.</p>
			</header>
			<div>
				<div class="row">
